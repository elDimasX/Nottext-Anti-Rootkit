					...
					if (Info)
					{
						...
						if (NT_SUCCESS(Status))
						{
							...
							if (Servico)
							{
								...
								PUNICODE_STRING LocalCompleto = ExAllocatePoolWithTag(PagedPool, 600, 'locl');
...
/// <param name="Parar">Se é para parar ou não</param>
/// 
...
/// 
/// <param name="NomeServico">Nome do serviço</param>
/// <param name="RetornarValor">Retornar</param>
/// 
