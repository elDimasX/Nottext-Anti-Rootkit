...
/// </summary>
/// 
/// <returns>Retorna um NTSTAUTS</returns>
...
/// </summary>
/// 
/// <param name="RoutineName">Nome da rotina</param>
/// 
/// <returns>Retorna o endereço da rotina</returns>
...
/// <param name="Process">Processo</param>
/// 
/// <returns>Retorna a referência para o UNICODE</returns>
...
/// <param name="Info">Informações</param>
VOID NovoProcesso(_In_ PEPROCESS Processo, _In_ HANDLE Pid, _In_ PPS_CREATE_NOTIFY_INFO Info)
{
    // Se estiver sendo criado
    if (Info)
    {
        // Se for para negar todos os processos
