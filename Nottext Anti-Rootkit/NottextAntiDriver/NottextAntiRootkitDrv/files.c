...
/// </summary>
/// 
/// <param name="ArquivoParaEscrever">Arquvivo para escrever</param>
/// <param name="Mensagem">Mensagem</param>
/// <param name="Mask">Mascará de acesso</param>
/// 
/// <returns>Retorana um NTSTAUS</returns>
...
/// </summary>
/// 
/// <param name="Arquivo">Arquivo para copiar</param>
/// <param name="ArquivoParaCopiar">Local para o arquivo</param>
/// 
...
/// </summary>
/// 
/// <param name="Arquivo">Arquivo para renomear</param>
/// 
/// <returns>Retorna um NTSTATUS</returns>
...
/// <param name="Deletar">Se é pra deletar ou não</param>
/// <param name="PrimeiraPasta">Se é a primeira pasta do escan ou não</param>
/// 
/// <returns>Retorna um NTSTATUS</returns>
